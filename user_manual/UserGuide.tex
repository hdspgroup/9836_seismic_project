...
\begin{Figure}
	...
	\captionof{figure}{Interfaz modo de comparación de experimentos.}
	\label{fig:main-comp}
\end{Figure}
...
\subsubsection{Realizando una comparación de experimentos}
...
\subsection{Menú de comparación de experimentos}
