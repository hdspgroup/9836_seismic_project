...
Por último, es posible cargar resultados de comparaciones de algoritmos. Para esto habilitamos el modo \textit{Comparación de Algoritmos} (ver figura \ref{comp-tab}), y presionamos el botón \textit{Ver Resultados} en la parte inferior izquierda. A modo de ejemplo, se cargó el archivo de resultados \emph{results\_comp.npz}, tal como se visualiza en la figura \ref{fig:report_6}. Este modo es exclusivamente de visualización y no permite modificar el rango de valores evaluados.
