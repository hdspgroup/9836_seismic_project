...
\documentclass[12pt,oneside,letter]{ol-softwaremanual}
\usepackage{float}
...
Una vez seleccionado el dato sísmico, se debe pulsar en la opción \emph{Abrir} y se podrá observar en \circled{2} como se muestra en la figura \ref{fig:data_lecture_3}. Aquí los datos se observan en el siguiente orden: \circled{I} representa al directorio padre y \circled{II} es el dato sísmico cargado hijo del directorio padre.
