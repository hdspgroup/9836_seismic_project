...
Al igual que con el modo de ajuste de parámetros, el modo de comparación modifica la interfaz gráfica, tal y como se muestra en la figura \ref{fig:main-comp}.
...
\begin{Figure}
	\centering
	\includegraphics[width=0.8\linewidth]{comp-tab.png}
