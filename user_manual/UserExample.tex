...
\begin{enumerate}
	...
	\begin{multicols}{2}
		\item Ubique, en la parte superior de la aplicación, el botón del menú de comparación de experimentos.
		\begin{Figure}
			\centering
			\includegraphics[width=0.4\linewidth]{comp-tab.png}
			\captionof{figure}{Modo de comparación de experimentos.}
			\label{fig:comp}
		\end{Figure}					
	\end{multicols}
	...
	\item La solución de la comparación de experimentos se presenta en las pestañas Rendimiento y Reporte de reconstrucción, tal como se muestra en las figuras \ref{fig:result-comp1} y \ref{fig:result-comp2} respectivamente.
	
	\begin{Figure}
		\centering
		\includegraphics[width=0.9\linewidth]{result-comp1.png}
		\captionof{figure}{Rendimiento de la comparación de experimentos}
	...
	\begin{Figure}
		...
		\captionof{figure}{Reporte de reconstrucción de la comparación de experimentos}
