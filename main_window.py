...
class UIMainWindow(QtWidgets.QMainWindow):
    ...
    def init_global_variables(self):
        ...
        self.state = dict(main=dict(progress=dict(iteration=[], error=[], psnr=[])),
                          tuning=dict(progress=dict(total_runs=0, fixed_params='')))
    ...
    def verify_parameters(self, uploaded_directory):
        ...
        if self.global_variables['tab_mode'] == 'tuning':
            ...
            for i in range(len(self.params[algorithm])):
                ...
                if tuning_type == 'intervalo' and i_diff:
                    validate_interval = float(number_init) < float(number_end)

                if tuning_type == 'lista' and i_diff:
                    try:
    ...
    def report_tuning_progress(self, num_run, err, psnr, params):
