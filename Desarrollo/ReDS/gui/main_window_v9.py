...
# Form implementation generated from reading ui file 'main_window_v9.ui'
#
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.TransposeCheckBox = QtWidgets.QCheckBox(self.inputGroupBox)
        self.TransposeCheckBox.setObjectName("TransposeCheckBox")
        self.inputHLayout.addWidget(self.TransposeCheckBox)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("assets/icons/view.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.param1Label.setPixmap(QtGui.QPixmap("../assets/parameters/lambda.png"))
        ...
        self.param2Label.setPixmap(QtGui.QPixmap("../assets/parameters/mu.png"))
        ...
        self.param3Label.setPixmap(QtGui.QPixmap("../assets/parameters/rho.png"))
        self.param3Label.setScaledContents(True)
        ...
        self.paramComboBox.setCurrentText("")
        self.paramComboBox.setObjectName("paramComboBox")
        self.paramComboBox.addItem("")
        self.paramComboBox.setItemText(0, "")
        self.paramComboBox.addItem("")
        self.paramComboBox.setItemText(1, "")
        self.paramComboBox.addItem("")
        self.paramComboBox.setItemText(2, "")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/view.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.sdHLayout.addWidget(self.seedHelpButton)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("assets/icons/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("assets/icons/run.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("assets/icons/report.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.performancePage.setGeometry(QtCore.QRect(0, 0, 1207, 367))
        ...
        self.reportPage.setGeometry(QtCore.QRect(0, 0, 1207, 367))
        ...
        self.comparisonPerformancePage.setGeometry(QtCore.QRect(0, 0, 1207, 367))
        ...
        self.comparisonReportPage.setGeometry(QtCore.QRect(0, 0, 1207, 367))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("assets/icons/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("assets/icons/main.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mainAction.setIcon(icon9)
        self.mainAction.setObjectName("mainAction")
        self.tuningAction = QtWidgets.QAction(mainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("assets/icons/tuning.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("assets/icons/comparison.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "ReDs - Reconstruccion de Receptores | Universidad Industrial de Santander"))
        ...
        self.TransposeCheckBox.setText(_translate("mainWindow", "Transpuesta"))
        ...
        self.algorithmComboBox.setItemText(4, _translate("mainWindow", "DeepNetwork"))
