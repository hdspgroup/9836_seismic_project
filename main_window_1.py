...
class MplCanvas(FigureCanvasQTAgg):
    ...
    def update_figure(self):
        try:
            ...
            axes_1.plot(self.iteracion, self.error, color=color)
            ...
            axes_2.plot(self.iteracion, self.psnr, color=color)
...
class UiMainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        # self.inputLineEdit.setText('/home/enmartz/Jobs/Seismic/9836_seismic_project/data/data.npy')
        # self.saveAsLineEdit.setText('ran')
