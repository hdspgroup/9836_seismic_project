...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.saveAsPushButton.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/run.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.resultPushButton.setIcon(icon4)
        ...
        self.aboutOfAction.setIcon(icon5)
        self.aboutOfAction.setObjectName("aboutOfAction")
        self.reportAction = QtWidgets.QAction(mainWindow)
        self.reportAction.setIcon(icon4)
        self.reportAction.setObjectName("reportAction")
        self.mainAction = QtWidgets.QAction(mainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/main.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mainAction.setIcon(icon6)
        self.mainAction.setObjectName("mainAction")
        self.tuningAction = QtWidgets.QAction(mainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/tuning.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tuningAction.setIcon(icon7)
        self.tuningAction.setObjectName("tuningAction")
        self.comparisonAction = QtWidgets.QAction(mainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/comparison.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comparisonAction.setIcon(icon8)
